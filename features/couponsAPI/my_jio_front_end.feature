...
Feature: Finding the latency of the APIs.
  Scenario Outline: Latency for MyJio frontend App
    ...
    Examples:
      ...
      |MyjioCategory         |GET              |Category       |Category      |Category   |https://api-sit.jio.com/cr/v2/coupons/category?|
      |MyjioFavourite        |GET              |Favourite      |Favourite     |Favourite  |https://api-sit.jio.com/cr/v2/coupons/favorites?|
      |MyjioAllCoupons       |GET              |AllCoupons     |AllCoupons    |AllCoupons |https://api-sit.jio.com/cr/v2/coupons?|
